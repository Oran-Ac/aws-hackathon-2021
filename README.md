...
###  <details><summary>难点未实现</summary><p> 税费计算：在阅读相关资料后，发现各国各类商品都不同，国家进出口中心上税务查询除了要输入出口国和进口国以外，还需要输入商品完整编号</p><p>邮费计算：邮费计算要求邮编等信息。在最初想要爬取联邦快递等跨国快递的网站给出指导价格，但是网站的操作逻辑导致无法爬取</p></details> 
